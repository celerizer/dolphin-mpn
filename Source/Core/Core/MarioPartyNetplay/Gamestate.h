...
const mpn_board_t MP7_BOARDS[] =
{
  {1, 0x7A, {"Grand Canal"}, {"mp7-canal"}},
...
const mpn_scene_t MP7_GAMESTATES[] =
{
...
const mpn_addresses_t MP8_ADDRESSES =
{
  0x00228764,
  0x00228765,
  0x002287CC,
...
const mpn_board_t MP8_BOARDS[] = {
  {1, 0x10, {"DK's Treetop Temple"}, {"mp8-dktt"}},
